// Using luxon global as suggested by in:
// https://moment.github.io/luxon/#/install?id=basic-browser-setup
...
document.getElementById('go_btn').addEventListener('click', displayTime);
...
function getInput() {
    ...
    return {
        inputCity: document.getElementById('input_city').value.toString(),
        outputCity: document.getElementById("output_city").value.toString(),
        day: day,
        month: month,
        year: year,
        hour: hour,
...
function getDateStr(input) {
    const inputTz = getTimeZone(input.inputCity);
